...
<Card title="fooof_aperiodic" icon="wave-square" href="/processing-blocks/fooof-aperiodic/overview">
  **specparam aperiodic (1/f) parameter extraction from source-localized data**
  ...
  **Purpose**: Extract aperiodic (1/f background) parameters from vertex-level source estimates using specparam algorithm (formerly FOOOF)
  ...
  **Scientific References**:
  - Donoghue et al. (2020) - specparam spectral parameterization
...
<Card title="fooof_periodic" icon="chart-scatter" href="/processing-blocks/fooof-periodic/overview">
  **specparam periodic (oscillatory peak) detection from source-localized data**
  ...
  **Purpose**: Detect and characterize oscillatory peaks (alpha, beta, theta, etc.) after removing aperiodic component using specparam (formerly FOOOF)
...
graph TD
    ...
    SourceLoc -->|1/f parameters?| Specparam_A[specparam_aperiodic]
    SourceLoc -->|Oscillatory peaks?| Specparam_P[specparam_periodic]
    ...
    style Specparam_A fill:#90EE90,stroke:#2F4F2F,stroke-width:2px
    style Specparam_P fill:#90EE90,stroke:#2F4F2F,stroke-width:2px
...
| **specparam_aperiodic** | 1/f parameters | SourceEstimate | Aperiodic params (20k vertices) | 🐌🐌 |
| **specparam_periodic** | Oscillatory peaks | SourceEstimate | Peak parameters (frequency, power, BW) | 🐌🐌 |
...
- ✅ specparam_aperiodic: 1/f parameter extraction (formerly FOOOF)
- ✅ specparam_periodic: Oscillatory peak detection (formerly FOOOF)