...
Every task is a **Python class with a run() method**. That method lists your preprocessing steps in order—import data, filter it, run ICA, create epochs. Each step transforms the data and passes it to the next step.

Think of it like a recipe: follow the steps in sequence, and you get clean, analyzed EEG data at the end.
