---
title: "Documentation Philosophy & Style Guide"
sidebarTitle: "Doc Style Guide"
description: "A comprehensive guide to creating exceptional technical documentation using prose-first principles and strategic Mintlify components"
icon: "book-open"
---

<Note>
**For Documentation Contributors**: This guide captures the philosophy, techniques, and patterns used throughout AutoCleanEEG documentation. Use it as a reference when contributing new pages or improving existing ones.
</Note>
