---
title: "LLM Reports (Optional)"
sidebarTitle: "LLM Reports"
description: "Opt-in AI-generated summaries from pipeline runs, written under task-root reports."
---

AutoCleanEEG can optionally generate textual summaries using a large
language model. These reports live under the task‑root
...
3. Run the pipeline as usual – reports appear under `reports/llm/` (or a
   subfolder keyed by the subject base name).
