...
<Steps>
  ...
  <Step title="Add the montage to configuration">
    Register your custom montage in the pipeline configuration to ensure validation passes when tasks reference `biosemi32_infant`.
  </Step>
...
- Troubleshooting: If validation fails, confirm your custom montage is properly registered and that your input file has the correct extension.

## Related Files

- `src/autoclean/plugins/eeg_plugins/bdf_biosemi32_infant_plugin.py` - Plugin implementation
- `src/autoclean/io/import_.py` - Import system registration